...
contract CashStaking is Ownable, ERC20 {
    ...
    function initialize(
        ...
        require(
            ...
            "CashStaking: staking token is the zero address"
        );
        require(
            _treasury != address(0),
            "CashStaking: treasury is the zero address"
        );
    ...
    function unstake(uint256 _stakeIndex) external {
        require(
            ...
            "CashStaking: invalid index"
        );
        Stake storage stakeRef = stakers[msg.sender][_stakeIndex];
        require(!stakeRef.unstaked, "CashStaking: unstaked already");
    ...
    function _transfer(
        ...
        revert("CashStaking: NON_TRANSFERABLE");
    }
}
